...
const ViewPresentationAssessments = () => {
  ...
  useEffect(() => {
    const fetchAssessments = async () => {
      try {
        ...
        const filteredAssessments = response.data.filter(assessment => assessment.assement_type === 'Presentation');
  ...
  return (
    <div className='Russa_assessment-container'>
      <h2>Added Presentation Assessments</h2>
...
export default ViewPresentationAssessments;
