  ...
  useEffect(() => {
    const fetchAssessments = async () => {
      try {
        ...
        const filteredAssessments = response.data.filter(assessment => assessment.assement_type === 'Viva');
...
export default ViewVivaAssessments;
